...
```json
{
  "mode-key": {
    ...
    "ai:baseurl": "http://localhost:11434/v1/chat/completions",
...
| `ai:baseurl` | No | Full API endpoint URL including path (e.g., `http://localhost:11434/v1/chat/completions`) |
...
```json
{
  "lmstudio-qwen": {
    ...
    "ai:thinkinglevel": "normal",
    "ai:baseurl": "http://localhost:1234/v1/chat/completions",
...
```json
{
  "jan-local": {
    ...
    "ai:thinkinglevel": "normal",
    "ai:baseurl": "http://localhost:1337/v1/chat/completions",
    "ai:apitoken": "not-needed"
  }
}
```
...
```json
{
  "openai-gpt51": {
    ...
    "ai:model": "gpt-5.1",
    "ai:thinkinglevel": "normal",
    "ai:baseurl": "https://api.openai.com/v1/responses",
    "ai:apitokensecretname": "OPENAI_KEY"
  }
}
```
...
```json
{
  "openrouter-qwen": {
    ...
    "ai:model": "qwen/qwen-2.5-coder-32b-instruct",
    "ai:thinkinglevel": "normal",
    "ai:baseurl": "https://openrouter.ai/api/v1/chat/completions",
...
```json
{
  "azure-gpt4": {
    ...
    "ai:thinkinglevel": "normal",
    "ai:baseurl": "https://your-resource.openai.azure.com/openai/deployments/your-deployment-name/chat/completions",
...
2. Check the `ai:baseurl` is the complete endpoint URL including the path (e.g., `/v1/chat/completions`)
