...
![The default widget bar](/img/all-widgets-default.png)

By adding additional widgets, it is possible to get a widget bar that looks like this:

![A widget bar with custom widgets added](/img/all-widgets-extra.png)
...
![The example speedtest widget](/img/widget-example-speed.png)
...
![The example speedtest widget](/img/widget-example-dua.png)
...
![The example speedtest widget](/img/widget-example-youtube.png)
...
![The example speedtest widget](/img/widget-example-github.png)
...
![The example speedtest widget](/img/widget-example-3mininfo.png)
...
![The example speedtest widget](/img/widget-example-all-cpu.png)
