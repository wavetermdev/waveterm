...
| ------------- | ------ | ----------------------------------------------------------- |
| display:name  | string | the name to use when displaying the preset in a menu        |
| display:order | float  | the order in which the preset should be displayed in a menu |
