...
| window:confirmclose                  | bool     | when `true`, a prompt will ask a user to confirm that they want to close a window if it has an unsaved workspace with more than one tab (defaults to `true`)                                                                                                  |
| window:alwaysconfirmclose            | bool     | when `true`, always prompt to confirm before closing any window, regardless of tab count or workspace state (defaults to `false`)                                                                                                                             |
