...
Wave supports powerful custom backgrounds for your tabs using images, patterns, gradients, and colors. You can add your own image backgrounds by creating a background preset. See our [Background Configuration](/presets#background-configurations) documentation for examples and detailed setup instructions.
