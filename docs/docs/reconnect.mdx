...
:::note
All other reconnect thresholds (keepalive interval, stall threshold, reconnect interval, etc.) are currently hardcoded. Issue [#19](https://github.com/whoisjeremylam/remoteterm/issues/19) will make them configurable per connection.
:::
