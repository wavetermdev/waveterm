...
A best-practice dropdown component for the Tsunami framework that can be easily used with JSON-serializable props from the backend.

## Features

- ✅ Pure JSON-serializable props (no functions or render functions in props)
- ✅ Consistent dark theme styling with Tailwind CSS
...
3. **Consistent Styling**: Uses Tailwind CSS classes matching other Tsunami elements
4. **Accessibility**: Built on semantic HTML `<select>` element with proper ARIA support
