...
(
    ...
    feopts              json        NOT NULL DEFAULT '{}',
    cmdstoretype        varchar(20)          DEFAULT 'session',
    openaiopts          json        NOT NULL DEFAULT '{}',
    releaseinfo         json        NOT NULL DEFAULT '{}'
);
...
(
    ...
    shellpref           varchar(20)  NOT NULL DEFAULT 'detect'
);
...
(
    50
) NOT NULL, linestate json NOT NULL DEFAULT '{}',
    PRIMARY KEY
(
    screenid,
    lineid
