...
func GetAllSessionsUpdate(ctx context.Context) (*ModelUpdate, error) {
	return WithTxRtn(ctx, func(tx *TxWrap) (*ModelUpdate, error) {
		...
		for _, screen := range screens {
			screen.Full = true
			AddUpdate(update, (ScreenUpdate)(*screen))
		}
...
func InsertScreen(ctx context.Context, sessionId string, origScreenName string, opts ScreenCreateOpts, activate bool) (*ModelUpdate, error) {
	...
	update := &ModelUpdate{}
	AddUpdate(update, (ScreenUpdate)(*newScreen))
	if activate {
		bareSession, err := GetBareSessionById(ctx, sessionId)
		if err != nil {
			return nil, txErr
		}
		AddUpdate(update, (SessionUpdate)(*bareSession))
...
func UpdateCmdDoneInfo(ctx context.Context, ck base.CommandKey, donePk *packet.CmdDonePacketType, status string) (*ModelUpdate, error) {
	...
	update := &ModelUpdate{}
	AddUpdate(update, (CmdUpdate)(*rtnCmd))
...
func DeleteScreen(ctx context.Context, screenId string, sessionDel bool, update *ModelUpdate) (*ModelUpdate, error) {
	...
	AddUpdate(update, (ScreenTombstoneUpdate)(*screenTombstone))
	AddUpdate(update, ScreenUpdate{SessionId: sessionId, ScreenId: screenId, Remove: true})
	if isActive {
		bareSession, err := GetBareSessionById(ctx, sessionId)
		if err != nil {
			return nil, err
...
func ArchiveScreenLines(ctx context.Context, screenId string) (*ModelUpdate, error) {
	...
	ret := &ModelUpdate{}
	AddUpdate(ret, (ScreenLinesUpdate)(*screenLines))
	return ret, nil
}
...
func DeleteScreenLines(ctx context.Context, screenId string) (*ModelUpdate, error) {
	...
	ret := &ModelUpdate{}
	AddUpdate(ret, (ScreenUpdate)(*screen))
	AddUpdate(ret, (ScreenLinesUpdate)(*screenLines))
	return ret, nil
}
...
func DeleteSession(ctx context.Context, sessionId string) (UpdatePacket, error) {
	...
	AddUpdate(update, SessionUpdate{SessionId: sessionId, Remove: true})
	if sessionTombstone != nil {
		AddUpdate(update, (SessionTombstoneUpdate)(*sessionTombstone))
	}
	return update, nil
}
