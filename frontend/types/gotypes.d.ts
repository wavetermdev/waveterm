...
declare global {
    ...
    // wshrpc.ForwardSessionInputData
    type ForwardSessionInputData = {
        stdin: string;
        termsize: TermSize;
    };

    // wshrpc.ForwardSessionOutputData
    type ForwardSessionOutputData = {
        stdout: string;
        stderr: string;
    };

    // wshrpc.ForwardSessionRequest
    type ForwardSessionRequest = {
        connname: string;
        stdinroute: string;
    };
