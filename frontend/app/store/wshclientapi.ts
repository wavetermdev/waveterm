...
class RpcApiType {
	...
	ForwardSessionInputCommand(client: WshClient, opts?: RpcOpts): AsyncGenerator<ForwardSessionInputData, void, boolean> {
        return client.wshRpcStream("forwardsessioninput", null, opts);
    }

    // command "forwardsessionoutput" [responsestream]
	ForwardSessionOutputCommand(client: WshClient, data: ForwardSessionRequest, opts?: RpcOpts): AsyncGenerator<ForwardSessionOutputData, void, boolean> {
