...
const allSettings: SettingMetadata[] = [
    ...
    },
    {
        key: "term:theme",
        label: "Theme",
        description: "The color theme for the terminal. Themes are defined in termthemes configuration.",
        category: "Terminal",
        subcategory: "Appearance",
        controlType: "select",
        defaultValue: "",
        type: "string",
        validation: { options: [] }, // Populated dynamically from termthemes
        tags: ["color", "theme", "appearance"],
    },
    {
        key: "term:scrollback",
