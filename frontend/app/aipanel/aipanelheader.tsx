...
import { WorkingDirectoriesStrip } from "./workingdirectoriesstrip";
...
export const AIPanelHeader = memo(({ onClose, model, onClearChat }: AIPanelHeaderProps) => {
    ...
    return (
        <div className="@container border-b border-gray-600">
            <div className="py-2 pl-3 pr-1 @xs:p-2 @xs:pl-4 flex items-center justify-between min-w-0">
            ...
            {!inBuilder && <WorkingDirectoriesStrip />}
        </div>
    );
});
