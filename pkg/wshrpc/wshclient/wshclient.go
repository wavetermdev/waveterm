...
func WaveAIGetModesCommand(w *wshutil.WshRpc, opts *wshrpc.RpcOpts) ([]uctypes.ThinkingModeConfig, error) {
	resp, err := sendRpcRequestCallHelper[[]uctypes.ThinkingModeConfig](w, "waveaigetmodes", nil, opts)
	return resp, err
}
